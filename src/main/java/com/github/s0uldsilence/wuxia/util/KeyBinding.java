...
public class KeyBinding {
    ...
    public static final String NAME_SCAN_ORES_KEY = "key.scan_ores";
    ...
    public static final KeyMapping SCAN_ORES_KEY = new KeyMapping(NAME_SCAN_ORES_KEY, KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_KP_ADD, KEY_CATEGORY_WUXIA);
}