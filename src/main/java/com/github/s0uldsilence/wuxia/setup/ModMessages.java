...
public class ModMessages {
    ...
    public static void register() {
        ...
        net.messageBuilder(ScanOresC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                .decoder(ScanOresC2SPacket::new)
                .encoder(ScanOresC2SPacket::toBytes)
                .consumerMainThread(ScanOresC2SPacket::handle)
                .add();
    }
